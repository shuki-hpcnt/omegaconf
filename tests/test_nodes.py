...
@pytest.mark.parametrize(
    "type_", [BooleanNode, EnumNode, FloatNode, IntegerNode, StringNode, UntypedNode],
)
@pytest.mark.parametrize(
    "values, success_map",
    [
        (
            ...
            (True, "Y", "true", "yes", "on"),
            {
                ...
                "UntypedNode": True,  # noqa F601
                "StringNode": str,  # noqa F601
                "UntypedNode": copy.copy,  # noqa F601
            },
        ),
        (
            ("1", 1, 10, -10),
        ...
        (
            ...
            {"FloatNode": float, "StringNode": str, "UntypedNode": copy.copy},
        ),
        (
            # False aliases
...
@pytest.mark.parametrize(
    "node_type",
    [BooleanNode, EnumNode, FloatNode, IntegerNode, StringNode, UntypedNode],
)
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {EnumNode: Enum1.FOO, UntypedNode: copy.copy, StringNode: str},
        ),
    ],
)
